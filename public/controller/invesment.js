...
import { InvestmentStatus, TransactionType, TransactionStatus, Prisma } from "../../generated/prisma/index.js";
    ...
    async updateInvestment(req, res) {
        try {
            ...
            if (amountInvested !== undefined) {
                ...
                updateData.amountInvested = new Prisma.Decimal(amountInvested);
            }
            if (roiPercentage !== undefined) {
                ...
                updateData.roiPercentage = new Prisma.Decimal(roiPercentage);
            }
            if (startDate)
            ...
            if (totalReturn !== undefined)
                updateData.totalReturn = totalReturn;
            // Update investment
...
//# sourceMappingURL=invesment.js.map